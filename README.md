...
| Time only       | | Only the time: hours, minutes and seconds in 24-hour format, or hours, minutes and AM/PM in 12-hour format. No glucose is shown, so the clock can look like an ordinary clock. While a glucose alarm is active (including snoozed), it shows the time and value like "Time and value". |
...
- Multiple clock faces support
  ...
  - Time only, showing glucose only while a glucose alarm is active
